...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-editing-style '(vim :variables
                                    ...
                                    vim-style-ex-substitue-global t)
...
before packages are loaded."
  ...
  ;; (add-hook 'lsp-javascript-typescript-hook (lambda () (setq lsp-javascript-typescript--get-root (lsp-make-traverser #'(lambda (dir) (directory-files dir nil "notes.txt"))))))
  ...
  (setq evil-emacs-state-cursor   '("#f8f8f2" box)
        evil-insert-state-cursor  '("#f1fa8c" (bar . 2))
        evil-motion-state-cursor  '("#50fa7b" box)
  ...
  (define-key evil-normal-state-map (kbd "C-S-o") 'prepend-newline)
  (define-key evil-insert-state-map (kbd "C-;") 'append-semicolon)
  (define-key evil-insert-state-map (kbd "C-,") 'append-comma)
  (define-key evil-insert-state-map (kbd "C-o") 'append-newline)
  (define-key evil-insert-state-map (kbd "C-S-o") 'prepend-newline)
